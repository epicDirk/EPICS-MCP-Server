...
def test_diagnose_pv_contains_pv_name():
    result = diagnose_pv("MPS:VAC:Pressure")
    assert "MPS:VAC:Pressure" in result


def test_diagnose_pv_contains_steps():
